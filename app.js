...
for(let i = 0; i<phones.length;i++){
    getMob.innerHTML+=`<div class="main"><h3>${phones[i].brand}</h3>
...
//     getMob.innerHTML +=`<div style="border-radius: 20px; gap:10; margin-top: 40px; margin-left: 40px;  background-color: #eecea7; ">
